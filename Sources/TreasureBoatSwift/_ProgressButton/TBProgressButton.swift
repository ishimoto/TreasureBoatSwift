...
public struct TBProgressButton<S, L, P, B>: View where S: Shape, L: View, P: View, B: View {

    @State private var isInProgress = false

    var clipShape: S
    var direction: ETBProgressButtonDirection
    var action: (@escaping () -> ()) -> ()
    ...
    public init(direction: ETBProgressButtonDirection = .down,
...
public enum ETBProgressButtonDirection: String, CaseIterable, Identifiable {
