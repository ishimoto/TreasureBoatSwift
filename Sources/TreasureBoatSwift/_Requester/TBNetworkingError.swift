...
public struct TBNetworkingError: Error, LocalizedError {
    ...
    public init(error: Error) {
        if let networkingError = error as? TBNetworkingError {
...
extension TBNetworkingError: CustomStringConvertible {
...
extension TBNetworkingError {
    
    public static var unableToParseResponse: TBNetworkingError {
        return TBNetworkingError(status: .unableToParseResponse)
    }
    
    public static var unableToParseRequest: TBNetworkingError {
        return TBNetworkingError(status: .unableToParseRequest)
    }
    
    public static var unknownError: TBNetworkingError {
        return TBNetworkingError(status: .unknown)
    }
