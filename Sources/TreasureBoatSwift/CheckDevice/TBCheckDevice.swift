...
open class TBCheckDevice {
    ...
    static fileprivate func getVersion(code: String) -> TBDeviceVersion {
        switch code {
            /*** iPhone ***/
            //old version
    ...
    static fileprivate func getType(code: String) -> TBDeviceType {
    ...
    static public func type() -> TBDeviceType {
        return getType(code: getVersionCode())
    }

    static public func version() -> TBDeviceVersion {
        return getVersion(code: getVersionCode())
    }
    
    static public func size() -> TBDeviceSize {
#if os(iOS)
        ...
        case 812:
            if #available(iOS 11.0, *) {
                return UIWindow.firstWindow()?.safeAreaLayoutGuide.layoutFrame.minY != 44 ?  .screen5_4Inch : .screen5_8Inch
            } else {
