...
public struct TBSlideInView<Content: View, Container: View>: View {
    
    private var edge: Edge
    private var paddingPercentage: CGFloat
    private var options: TBSlideInViewOptions
    @ViewBuilder private var content: () -> Content
    @ViewBuilder private var container: () -> Container
    
    @StateObject private var context: TBSlideInViewManagerContext
    
    public init(_ edge: Edge = .leading,
                paddingPercentage: CGFloat = 0.35,
                options: TBSlideInViewOptions = TBSlideInViewOptions(),
        ...
        self._context = StateObject(wrappedValue: TBSlideInViewManagerContext())
    }
...
public extension TBSlideInView {
