...
/// `https://www.youtube.com/watch?v=Jdfwt3kANB8`
public struct TBActiveText<Content: View>: View {
    ...
    public var body: some View {
        TBFlowView(data, vSpacing: lineOffset, hSpacing: 0, alignment: alignment) { string in
